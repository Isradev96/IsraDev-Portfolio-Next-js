...
const Services = () => {
  return (
    ...
    className="min-h-screen flex items-center py-24 xl:py-0">
      <div className="container mx-auto w-full h-full flex flex-col gap-10">
        {/* text */}
        ...
        <Swiper
          ...
          className="h-[275px] xl:h-[320px]"
        >
          {services.map((item, index) => {
            return <SwiperSlide key={index} className="h-full">
              <div className="bg-secondary/90 w-full h-[250px] rounded-[20px] px-[30px] py-[40px] flex flex-col justify-between">
                <div className="flex items-center justify-between mb-12">
                  <Image src={item.icon} width={48} height={48} alt="Image Service Icon"/>
