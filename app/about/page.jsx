...
const About = () => {
  return (
    <motion.section
      ...
      className="min-h-[calc(100vh-80px)] pt-[80px] flex items-center"
    >
      <div className="container mx-auto px-0">
        <div className="flex flex-col xl:flex-row items-center gap-24 w-full h-[680px]">
          {/* img & social icons */}
          <div className="hidden xl:flex flex-col w-full h-full pt-14 max-w-[430px] relative">
            <Image src='/assets/avatar.webp' width={320} height={496} alt="avatar img" className="z-20 relative" priority quality={100} />
            {/* overlay */}
            <div className="w-full h-[60px] absolute left-0 top-[476px] right-0 bg-gradient-to-t from-primary via-primary/90 z-30"></div>
          ...
          {/* scroll area */}
          <ScrollArea className="w-full h-[42.5rem] pb-40">
            <div>
              ...
              <h2 className="h2 mb-6">
                <span className="text-accent">Isra</span> Dev
              </h2>
