    ...
    >
      ...
      <div className="flex flex-col xl:flex-row items-center justify-between w-full">
        ...
        <div className="w-full xl:w-[650px] flex flex-col items-center xl:items-start text-center xl:text-left">
          ...
          {/* socials */}
          <Socials containerStyles='flex 2xl:flex-col gap-6 xl:mt-12 2xl:flex 2xl:absolute 2xl:top-1/2 2xl:right-2 2xl:transform 2xl:-translate-x-1/2 2xl:-translate-y-1/2' iconStyles='bg-accent text-white hover:bg-accent-hover transition w-[48px] h-[48px] text-[22px] flex items-center justify-center rounded-full cursor-pointer'/>
        </div>
        ...
        <div className="hidden xl:block flex-1 relative z-20">
          ...
          <Image
            ...
            height="auto"
            quality={100}
            className="absolute top-5 left-[150px]"
            priority
          />
          {/* overlay gradient */}
          <div className="w-[90%] h-[164px] absolute bottom-0 left-0 right-0 bg-gradient-to-t from-primary via-primary/90 to-transparent"></div>
        </div>
      </div>
    </motion.section>
  );
